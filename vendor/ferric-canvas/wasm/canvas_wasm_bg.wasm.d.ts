...
export const ferriccanvas_compositionUpdate: (a: number, b: number, c: number) => [number, number, number];
export const ferriccanvas_fromSceneJson: (a: number, b: number) => [number, number, number];
export const ferriccanvas_keyDown: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const ferriccanvas_new: (a: number, b: number) => [number, number, number];
export const ferriccanvas_pointerCancel: (a: number) => [number, number, number];
