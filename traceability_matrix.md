...
| ID | 需求 | 實作位置 | 驗證方式 | 狀態 |
|---|---|---|---|---|
| FR-01 | 開啟 Codex 原生畫布 Widget | `mcp/server.mjs`, `mcp/lib/widget.mjs` | MCP tools/list + render smoke test | 已實作，待實機 |
...
| FR-07 | 專案內持久化 | `mcp/lib/storage.mjs` | 儲存後重開 Widget | 已實作，待整合測試 |
...
| NFR-01 | 路徑穿越防護 | `mcp/lib/safety.mjs` | `tests/safety.test.mjs` | 6/6 測試組合通過 |
